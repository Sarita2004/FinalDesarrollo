                    ...
                    <div class="card-body">
                        <form action="../Controllers/editarProfesor.php?id_profesor=<?= $profesor->id_profesor ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="<?= $profesor->estado_civil ?>" name="estado_civil" id="estado_civil" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label for="genero">Género</label>
                                <input type="text" value="<?= $profesor->genero ?>" name="genero" id="genero" class="form-control" required>
                            </div>
